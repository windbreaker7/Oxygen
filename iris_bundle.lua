...
local _iris_WidgetTypes = (function()
    local script = { Name = "WidgetTypes.lua" }
    --[=[
        @within Iris
        @type ID string
    ]=]
...
local _iris_config = (function()
    local script = { Name = "config.lua" }
...
local _iris_widgets_init = (function()
    local script = { Name = "init.lua" }
    local Types = _iris_Types
    ...
    return function(Iris: Types.Internal)
        ...
        _iris_widgets_Root(Iris, widgets)
        _iris_widgets_Window(Iris, widgets)
    
        _iris_widgets_Menu(Iris, widgets)
    
        _iris_widgets_Format(Iris, widgets)
    
        _iris_widgets_Text(Iris, widgets)
        _iris_widgets_Button(Iris, widgets)
        _iris_widgets_Checkbox(Iris, widgets)
        _iris_widgets_RadioButton(Iris, widgets)
        _iris_widgets_Image(Iris, widgets)
    
        _iris_widgets_Tree(Iris, widgets)
        _iris_widgets_Tab(Iris, widgets)
    
        _iris_widgets_Input(Iris, widgets)
        _iris_widgets_Combo(Iris, widgets)
        _iris_widgets_Plot(Iris, widgets)
    
        _iris_widgets_Table(Iris, widgets)
    end
end)()
...
local _iris_init = (function()
    ...
    local Internal: Types.Internal = _iris_Internal(Iris)
    ...
    Iris.TemplateConfig = _iris_config
    ...
    Iris.ShowDemoWindow = _iris_demoWindow(Iris)
    
    _iris_widgets_init(Internal)
    _iris_API(Iris)
